...
public class SlidingPaneLayout extends ViewGroup {
    ...
    private List<View> mIgnoredViews = new ArrayList<View>();//hack by Fooyou
    ...
    private static boolean viewIsOpaque(View v) {
        if (isOpaque(v)) return true;// hack by Fooyou
    ...
    protected void onAttachedToWindow() {
        ...
        findIgnoredView(this);// hack by Fooyou
        mFirstLayout = true;
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (lp.slideable) {
                ...
                mSlideRange = range;//  may be changed  note by  Fooyou
...
//            left=480;// hack by Fooyou
     ...
     * @param ev
     * @return  
     * @author: by Fooyou 2014年3月4日  下午3:01:28
     */
    private boolean isIgnoredViewUnder(MotionEvent ev){
    	for (View v : mIgnoredViews) {
    		if (isPointInsideView((int)ev.getX(),(int)ev.getY(),v)) {
    			return true;
			}
		}
		return false;
    ...
    /** 功能：
     * @param v  
     * @author: by Fooyou 2014年3月4日  下午3:01:23
     */
     ...
     * @param view
     * @return  
     * @author: by Fooyou 2014年3月4日  下午3:03:42
     */
    private boolean isPointInsideView(float x, float y, View view){
        ...
        if(( x > viewX && x < (viewX + view.getWidth())) &&
        	...
        	if(BuildConfig.DEBUG) Log.w(TAG, "isPointInsideView >>true "+view.toString());
            return true;
        } else {
        	if(BuildConfig.DEBUG) Log.w(TAG, "isPointInsideView >>false "+view.toString());
            return false;
        }
    }
