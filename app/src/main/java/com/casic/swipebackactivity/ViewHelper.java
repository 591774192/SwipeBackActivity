...
import static com.casic.swipebackactivity.AnimatorProxy.NEEDS_PROXY;
import static com.casic.swipebackactivity.AnimatorProxy.wrap;


@SuppressLint("NewApi") public final class ViewHelper {
    private ViewHelper() {}
